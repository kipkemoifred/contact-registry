...
public class UserDAO {
    private static final String INSERT_USER_SQL = "INSERT INTO contacts (full_name, email,phone_number,id_number) VALUES (?, ? ,? ,? )";
    private static final String SELECT_USER_BY_ID = "SELECT id, full_name, email FROM contacts WHERE id = ?";
    ...
    private static final String UPDATE_USER_SQL = "UPDATE contacts SET full_name = ?, email = ?,  WHERE id = ?";
